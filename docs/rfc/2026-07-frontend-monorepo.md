...
![Целевая архитектура](assets/frontend-monorepo-architecture.png)
...
![Граф пакетов](assets/turbo-package-graph.png)
...
![Параллельное выполнение задач](assets/turbo-tasks-fast.png)
...
![Локальное кэширование](assets/turbo-local-caching.png)

![Remote cache](assets/turbo-remote-caching.png)
...
![FULL TURBO](assets/turbo-full-turbo.png)
